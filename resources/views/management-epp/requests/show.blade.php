...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('management-epp.requests.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('management-epp.requests.exportPdf', $jobOrder) }}?stream=1" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors duration-200" target="_blank">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
