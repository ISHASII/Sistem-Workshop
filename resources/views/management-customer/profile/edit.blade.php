        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('management-customer.dashboard') }}"
                    class="inline-flex items-center px-3 py-2 bg-slate-100 text-slate-700 rounded-md">Kembali</a>
            </div>
            ...
            <form id="profileForm" action="{{ route('management-customer.profile.update') }}" method="POST"
                class="space-y-6">
                @csrf
                @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="current_password" type="password" name="current_password"
                                    ...
                                    class="w-full pr-12 px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition-all duration-200">
                                <button type="button" data-toggle-target="current_password"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 toggle-password z-10 pointer-events-auto"
                                    ...
                                    <svg class="eye-closed w-5 h-5 hidden" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.223-3.396M6.1 6.1A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.98 9.98 0 01-4.1 5.2M3 3l18 18" />
                                    </svg>
                                </button>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <input id="new_password" type="password" name="password" autocomplete="new-password"
                                    class="w-full pr-12 px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition-all duration-200">
                                <button type="button" data-toggle-target="new_password"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 toggle-password z-10 pointer-events-auto"
                            ...
                            <p class="text-xs text-slate-400 mt-1">Minimum 8 karakter. Kosongkan jika tidak ingin mengubah.
                            </p>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <input id="confirm_password" type="password" name="password_confirmation"
                                    ...
                                    class="w-full pr-12 px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition-all duration-200">
                                <button type="button" data-toggle-target="confirm_password"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 toggle-password z-10 pointer-events-auto"
                ...
                <div class="flex justify-end">
                    <a href="{{ route('management-customer.dashboard') }}"
                        class="px-4 py-2 mr-2 bg-slate-100 text-slate-700 rounded-md">Batal</a>
