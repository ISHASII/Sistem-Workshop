    ...
    <main class="w-full max-w-lg">
        <div class="bg-white rounded-3xl shadow-2xl border border-red-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-500 p-8 text-white">
                ...
                <p class="text-red-50 text-sm leading-relaxed">Buat akun customer Anda dan nikmati kemudahan akses ke berbagai layanan kami</p>
            </div>
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('customer.register.store') }}" class="space-y-5">
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-xl p-4 flex gap-3">
                        ...
                        <p class="text-sm text-red-800">Password minimal 8 karakter dan harus sama dengan konfirmasi password</p>
                    </div>

                    <!-- Action Buttons -->
                    <div class="pt-2 space-y-3">
                        <button type="submit" class="w-full px-6 py-3 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white rounded-xl font-semibold shadow-lg shadow-red-500/30 hover:shadow-xl hover:shadow-red-500/40 transition-all duration-200 transform hover:-translate-y-0.5">
                            Daftar Sekarang
                        </button>
                        ...
                        <a href="{{ route('login') }}" class="block w-full px-6 py-3 bg-white border-2 border-red-600 text-red-600 rounded-xl font-semibold hover:bg-red-50 transition-all duration-200 text-center">
                            Kembali ke Login
                        </a>
                    </div>
                </form>
