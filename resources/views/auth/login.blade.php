...
<body class="bg-gray-100 min-h-screen flex items-start justify-center font-sans">
    <main class="w-full max-w-md px-4 pt-12">
        ...
        <div class="text-center mb-6">
            <div class="mx-auto mb-4" style="width:48px; height:48px;">
                <div class="rounded-full flex items-center justify-center"
                    style="width:48px; height:48px; background: linear-gradient(135deg,#dc2626 0%,#b91c1c 100%); box-shadow: 0 3px 8px rgba(220,38,38,0.08);">
                    <!-- lock icon -->
            ...
            <h1 class="text-lg sm:text-xl font-extrabold text-gray-900"
                style="font-family: Arial, Helvetica, sans-serif;">Sistem Workshop</h1>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            ...
            <form method="POST" action="{{ url('/login') }}" novalidate class="space-y-5">
                ...
                <div>
                    ...
                    <input id="username" type="text" name="username" value="{{ old('username') }}" autofocus class="w-full border border-red-500 bg-red-100 rounded-lg px-3 py-2.5 text-gray-700
                ...
                <div>
                    ...
                    <input id="password" type="password" name="password" class="w-full border border-red-500 bg-red-100 rounded-lg px-3 py-2.5 text-gray-700
                            focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition
                            autofill:bg-red-100" required>
                    @error('password')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" name="captcha" placeholder="Masukkan kode di atas" class="w-full border border-red-500 bg-red-100 rounded-lg px-3 py-2.5 text-gray-700
                            focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition
                            autofill:bg-red-100" required>
                ...
                <!-- Monitor Button -->
                <a href="{{ url('/monitor') }}"
                    class="w-full mt-3 block bg-yellow-400 hover:bg-yellow-500 text-gray-900 py-3 rounded-lg font-semibold text-lg shadow-md transition text-center">
                    Monitoring
                </a>

                <div class="mt-3 text-center">
                    <a href="{{ route('customer.register') }}"
                        class="inline-block text-sm text-red-600 font-semibold">Belum punya akun? Daftar sebagai
                        Customer</a>
                </div>
            </form>
        </div>
