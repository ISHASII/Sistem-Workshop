    ...
    <nav
                ...
                <div class="flex items-center space-x-8"
                    ...
                    <div class="hidden lg:flex items-center space-x-1">
                        ...
                        <a href="{{ route('admin.dashboard') }}"
                            class="nav-link group flex items-center px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-red-100 text-red-700 font-bold' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                        ...
                        <a href="{{ route('admin.users.index') }}"
                            class="nav-link group flex items-center px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-red-100 text-red-700 font-bold' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                            <svg class="w-4 h-4 mr-1.5 group-hover:scale-110 transition-transform duration-200"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 11V7a4 4 0 10-8 0v4M5 21h14a2 2 0 002-2V9H3v10a2 2 0 002 2z"></path>
                            </svg>
                            Akun
                        </a>
                        ...
                        <div class="relative group">
                            <button
                                ...
                                Master Data
                                <svg class="w-3 h-3 ml-1 group-hover:rotate-180 transition-transform duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="p-1.5">
                                    ...
                                    @if(Route::has('admin.satuan.index'))
                                        <a href="{{ route('admin.satuan.index') }}"
                                            class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200 {{ request()->routeIs('admin.satuan.*') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:text-emerald-600 hover:bg-emerald-50' }}">
                                            <div
                                                class="w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 {{ request()->routeIs('admin.satuan.*') ? 'bg-emerald-200' : 'bg-emerald-100' }}">
                                    ...
                                    @if(Route::has('admin.checklist-quality.index'))
                                        <a href="{{ route('admin.checklist-quality.index') }}"
                                            class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200 {{ request()->routeIs('admin.checklist-quality.*') ? 'bg-sky-50 text-sky-700' : 'text-slate-600 hover:text-sky-600 hover:bg-sky-50' }}">
                                            <div
                                                class="w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 {{ request()->routeIs('admin.checklist-quality.*') ? 'bg-sky-200' : 'bg-sky-100' }}">
                                            ...
                                            <div class="font-medium">Checklist Kualitas</div>
                                        </a>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="relative group">
                            <button
                                class="nav-dropdown-button flex items-center px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.materials.*') || request()->routeIs('admin.material-movements.*') ? 'bg-red-100 text-red-700 font-bold' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                                <svg class="w-4 h-4 mr-1.5 group-hover:scale-110 transition-transform duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div
                                class="nav-dropdown absolute left-0 mt-2 w-52 bg-white/95 backdrop-blur-xl rounded-xl shadow-xl shadow-slate-900/10 border border-slate-200/50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                                <div class="p-1.5">
                                    <a href="{{ route('admin.materials.index') }}"
                                        class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200 {{ request()->routeIs('admin.materials.*') ? 'bg-purple-50 text-purple-700' : 'text-slate-600 hover:text-purple-600 hover:bg-purple-50' }}">
                                        <div
                                            class="w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 {{ request()->routeIs('admin.materials.*') ? 'bg-purple-200' : 'bg-purple-100' }}">
                                    ...
                                    <a href="{{ route('admin.material-movements.index') }}"
                                        class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200 {{ request()->routeIs('admin.material-movements.*') ? 'bg-green-50 text-green-700' : 'text-slate-600 hover:text-green-600 hover:bg-green-50' }}">
                                        <div
                                            class="w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 {{ request()->routeIs('admin.material-movements.*') ? 'bg-green-200' : 'bg-green-100' }}">
                        ...
                        <div class="relative group">
                            <button
                                class="nav-dropdown-button flex items-center px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.manpower.*') || request()->routeIs('admin.performance.*') ? 'bg-red-100 text-red-700 font-bold' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                                <svg class="w-4 h-4 mr-1.5 group-hover:scale-110 transition-transform duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div
                                ...
                                <div class="p-1.5">
                                    <a href="{{ route('admin.manpower.index') }}"
                                        class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200 {{ request()->routeIs('admin.manpower.*') ? 'bg-red-50 text-red-700' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                                        <div
                                            class="w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 {{ request()->routeIs('admin.manpower.*') ? 'bg-red-200' : 'bg-red-100' }}">
                                    ...
                                    <a href="{{ route('admin.performance.index') }}"
                                        class="flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200 {{ request()->routeIs('admin.performance.*') ? 'bg-red-50 text-red-700' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                                        <div
                                            class="w-7 h-7 rounded-lg flex items-center justify-center mr-2.5 {{ request()->routeIs('admin.performance.*') ? 'bg-red-200' : 'bg-red-100' }}">
                                            <svg class="w-3.5 h-3.5 text-red-600" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('admin.joborder.index') }}"
                            class="nav-link group flex items-center px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.joborder.*') ? 'bg-red-100 text-red-700 font-bold' : 'text-slate-600 hover:text-red-600 hover:bg-red-50' }}">
                            <svg class="w-4 h-4 mr-1.5 group-hover:scale-110 transition-transform duration-200"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if(auth()->user()->role === 'admin')
                        <div class="hidden md:block relative">
                            <a href="{{ route('admin.notifications.index') }}"
                                class="relative flex items-center justify-center w-10 h-10 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 group">
        ...
        <div id="mobile-menu" class="lg:hidden hidden border-t border-slate-200/50 bg-white/95 backdrop-blur-xl">
            <div class="px-4 pt-4 pb-6 space-y-2">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-red-50 text-red-700' : '' }}">
                ...
                @if(auth()->user()->role === 'admin')
                    <a href="{{ route('admin.notifications.index') }}"
                        class="flex items-center px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.notifications.*') ? 'bg-red-50 text-red-700' : '' }}">
                        <div class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5 mr-3">
                                <path
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="flex items-center px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-red-50 text-red-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 11V7a4 4 0 10-8 0v4M5 21h14a2 2 0 002-2V9H3v10a2 2 0 002 2z"></path>
                    </svg>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.manpower.index') }}"
                        class="flex items-center px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 ml-4 {{ request()->routeIs('admin.manpower.*') ? 'bg-red-50 text-red-700' : '' }}">
                        <div
                            class="w-6 h-6 bg-red-100 rounded-lg flex items-center justify-center mr-3 {{ request()->routeIs('admin.manpower.*') ? 'bg-red-200' : 'bg-red-100' }}">
                    ...
                    <a href="{{ route('admin.performance.index') }}"
                        class="flex items-center px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 ml-4 {{ request()->routeIs('admin.performance.*') ? 'bg-red-50 text-red-700' : '' }}">
                        <div
                            class="w-6 h-6 bg-red-100 rounded-lg flex items-center justify-center mr-3 {{ request()->routeIs('admin.performance.*') ? 'bg-red-200' : 'bg-red-100' }}">
                            <svg class="w-3 h-3 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.materials.index') }}"
                        class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 ml-4 {{ request()->routeIs('admin.materials.*') ? 'bg-purple-50 text-purple-700' : 'text-slate-600 hover:text-purple-600 hover:bg-purple-50' }}">
                        <div
                            class="w-6 h-6 rounded-lg flex items-center justify-center mr-3 {{ request()->routeIs('admin.materials.*') ? 'bg-purple-200' : 'bg-purple-100' }}">
                    ...
                    <a href="{{ route('admin.material-movements.index') }}"
                        class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 ml-4 {{ request()->routeIs('admin.material-movements.*') ? 'bg-green-50 text-green-700' : 'text-slate-600 hover:text-green-600 hover:bg-green-50' }}">
                        <div
                            class="w-6 h-6 rounded-lg flex items-center justify-center mr-3 {{ request()->routeIs('admin.material-movements.*') ? 'bg-green-200' : 'bg-green-100' }}">
                ...
                <!-- Job Order -->
                <a href="{{ route('admin.joborder.index') }}"
                    class="flex items-center px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.joborder.*') ? 'bg-red-50 text-red-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2">
                        </path>
                ...
                <div class="px-4 pt-4 pb-6">
                    <div class="flex items-center space-x-3 bg-slate-50 rounded-xl px-4 py-3 mb-4">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="inline-flex items-center px-3 py-2 bg-red-50 text-red-700 rounded-md text-sm hover:bg-red-100">Logout</button>
                        </form>
                    </div>
