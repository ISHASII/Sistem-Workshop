    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-600 mt-1">Perbarui informasi kategori: <span class="font-semibold text-red-600">{{ $kategori->name }}</span></p>
            </div>
        </div>
                ...
                <div class="bg-rose-50 border border-rose-200 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-red-700 mt-1">Perubahan nama kategori akan mempengaruhi semua material yang menggunakan kategori ini. Pastikan perubahan sudah sesuai sebelum menyimpan.</p>
                        </div>
                    </div>
                </div>
