...
@section('content')
    <div class="min-h-screen bg-gray-50 p-4 flex flex-col">
        <!-- Header Section -->
        <div class="bg-gradient-to-r from-slate-50 to-slate-100 rounded-lg p-6 border border-slate-200 mb-6">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="flex items-end gap-2">
                            <p class="text-3xl font-bold text-slate-900">{{ $totalMaterials }}</p>
            ...
            <form method="GET" action="{{ route('admin.materials.index') }}" class="space-y-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" 
                                   ...
                                   class="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="md:col-span-2 flex items-end gap-2">
                        <button type="submit" class="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-colors duration-200">
