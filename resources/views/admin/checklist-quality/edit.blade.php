...
@section('title', 'Edit Checklist Kualitas')
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-slate-800">Edit Checklist Kualitas</h1>
                <p class="text-slate-600 mt-1">Perbarui checklist: <span
                        class="font-semibold text-red-600">{{ $checklistQualityItem->name }}</span></p>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-r from-red-50 to-rose-100 px-6 py-4 border-b border-red-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-600">Perbarui nama, urutan, dan status</p>
                    </div>
                </div>
            </div>

            <!-- Form Body -->
            <form action="{{ route('admin.checklist-quality.update', $checklistQualityItem) }}" method="POST"
                class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $checklistQualityItem->name) }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="sort_order" name="sort_order"
                            value="{{ old('sort_order', $checklistQualityItem->sort_order) }}" min="0"
                    ...
                    <div>
                        ...
                        <label
                            ...
                            <input type="checkbox" name="is_active" value="1" class="h-4 w-4 text-red-600" {{ old('is_active', $checklistQualityItem->is_active) ? 'checked' : '' }}>
                ...
                <div class="bg-rose-50 border border-rose-200 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-red-700 mt-1">Perubahan checklist akan mempengaruhi form performance yang
                                menggunakan opsi ini.</p>
                        </div>
                    </div>
                </div>
