...
@section('title', 'Tambah Man Power')
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-slate-800">Tambah Manpower Baru</h1>
                <p class="text-slate-600 mt-1">Isi form di bawah untuk menambahkan data karyawan baru</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-rose-50 to-red-50 px-6 py-4 border-b border-rose-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-slate-800">Informasi Manpower</h2>
                        <p class="text-sm text-slate-600">Data identitas dan status karyawan</p>
                    </div>
                </div>
            </div>

            <!-- Form Body -->
            <form action="{{ route('admin.manpower.store') }}" method="POST" enctype="multipart/form-data"
                class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="nrp" name="nrp" value="{{ old('nrp') }}" placeholder="Contoh: NRP001"
                            class="w-full pl-12 pr-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all duration-200 @error('nrp') border-red-300 focus:border-red-500 focus:ring-red-500/10 @enderror"
                            required>
                    </div>
                    @error('nrp')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                            ...
                            class="w-full pl-12 pr-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all duration-200 @error('nama') border-red-300 focus:border-red-500 focus:ring-red-500/10 @enderror"
                            required>
                    </div>
                    @error('nama')
                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select id="status_pegawai" name="status_pegawai"
                                ...
                                <option value="kontrak" {{ old('status_pegawai') == 'kontrak' ? 'selected' : '' }}>Kontrak
                                </option>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <button id="photo-clear-btn"
                                class="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-slate-200 text-red-600 rounded-lg shadow-sm hover:bg-slate-50">Hapus
                                preview</button>
                            <p class="text-xs text-slate-500 mt-1">Klik "Hapus preview" untuk mengosongkan file yang dipilih
                                sebelum menyimpan.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-rose-50 border border-rose-200 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-rose-800">Informasi</p>
                            <p class="text-sm text-rose-700 mt-1">Pastikan semua data yang diisi sudah benar dan sesuai
                                dengan dokumen resmi karyawan.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-slate-200">
                    <button type="submit"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-rose-600 to-red-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl hover:from-rose-700 hover:to-red-700 transition-all duration-200">
