        ...
        <div class="max-w-4xl mx-auto px-2 sm:px-4">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-slate-800 mb-2">Buat Job Order</h1>
                        <p class="text-slate-600">Isi detail untuk membuat job order baru</p>
                    </div>
                ...
                <div class="bg-gradient-to-r from-red-500 to-red-600 p-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-red-100 text-sm">Mohon berikan informasi yang akurat untuk job order</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <select name="status" required
                                        ...
                                        <option value="Medium" {{ old('status') == 'Medium' ? 'selected' : '' }}>Medium
                                        </option>
                                        <option value="High" {{ old('status') == 'High' ? 'selected' : '' }}>High</option>
                                        <option value="Urgent" {{ old('status') == 'Urgent' ? 'selected' : '' }}>Urgent
                                        </option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-slate-300" fill="none" stroke="currentColor"
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <div class="relative">
                                    <input name="project" type="text" required
                                        class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition-all duration-200"
                                        placeholder="Masukkan nama proyek" value="{{ old('project') }}">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-slate-300" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="target" type="text" value="{{ old('target') }}"
                                    class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800"
                                    placeholder="Jelaskan Target" />
                            </div>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <textarea name="latar_belakang"
                                    class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800"
                                    rows="4"
                                    placeholder="Jelaskan latar belakang proyek">{{ old('latar_belakang') }}</textarea>
                            </div>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <textarea name="tujuan"
                                    class="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800"
                                    rows="3" placeholder="Tujuan dari pekerjaan ini">{{ old('tujuan') }}</textarea>
                            </div>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <div id="image-inputs" class="space-y-2">
                                    <div class="image-input-row flex items-start space-x-3">
                                        ...
                                        <button type="button"
                                            class="remove-image-input hidden px-2 py-1 bg-slate-100 text-red-600 rounded">&times;</button>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <input name="start" type="text" required
                                        ...
                                        placeholder="Pilih tanggal mulai" autocomplete="off" value="{{ old('start', '') }}">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-slate-300" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="form-group">
                                ...
                                <div class="relative">
                                    <input name="end" type="text" required
                                        class="datepicker w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:bg-white focus:border-red-500 focus:ring-4 focus:ring-red-500/10 transition-all duration-200"
                                        placeholder="Pilih tanggal selesai" autocomplete="off" value="{{ old('end', '') }}">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <svg class="w-5 h-5 text-slate-300" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-slate-200">
                        <div class="text-sm text-slate-500">
                            <span class="flex items-center">
                                ...
                                Mohon tinjau semua informasi sebelum mengirim
                            </span>
                        </div>
                        <div class="flex items-center space-x-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const bookedDateRanges = rawBooked.map(function (r) {
                try { var pf = String(r.from).split('-'); var pt = String(r.to).split('-'); var fd = new Date(parseInt(pf[0], 10), parseInt(pf[1], 10) - 1, parseInt(pf[2], 10)); var td = new Date(parseInt(pt[0], 10), parseInt(pt[1], 10) - 1, parseInt(pt[2], 10)); td.setHours(23, 59, 59, 999); return { from: fd, to: td }; } catch (e) { return null; }
            ...
            document.querySelectorAll('.datepicker').forEach(function (el) {
                ...
                const opts = {
                    ...
                    onDayCreate: function (dObj, dStr, fp, dayElem) {
                        try {
                            var dateObj = new Date(dayElem.dateObj.getFullYear(), dayElem.dateObj.getMonth(), dayElem.dateObj.getDate()).getTime();
                            var isBooked = false;
                            for (var k = 0; k < bookedDateRanges.length; k++) {
                                var br = bookedDateRanges[k];
                                if (!br) continue;
                                if (dateObj >= br.from.getTime() && dateObj <= br.to.getTime()) {
                ...
                // Do not restrict the start picker to earliest; allow navigation and selection except booked ranges.
                ...
                // prevent selecting booked days by clicking or keyboard
                ...
                // save references for start/end pickers
                if (el.name === 'start') {
                    window._fpStart = fp;
                    // update end constraints on manual typing of start value
                    el.addEventListener('blur', function () {
                        try {
                            ...
                            var ns = null;
                            for (var ii = 0; ii < bookedDateRanges.length; ii++) { var br = bookedDateRanges[ii]; if (br && br.from && br.from.getTime() > t) { ns = br.from; break; } }
                        ...
                        } catch (e) { console.warn('Error updating end on blur', e); }
                    });
                }
                if (el.name === 'end') window._fpEnd = fp;

                // If this is the start picker, update end picker constraints upon change
                if (el.name === 'start') {
                    fp.config.onChange.push(function (selectedDates) {
                        try {
                            ...
                            var nextStart = (function (d) {
                                try { var t = new Date(d.getFullYear(), d.getMonth(), d.getDate()).getTime(); for (var ii = 0; ii < bookedDateRanges.length; ii++) { var br = bookedDateRanges[ii]; if (br && br.from && br.from.getTime() > t) return br.from; } } catch (e) { }
                                return null;
                            })(selectedStart);
                            if (nextStart) {
                ...
                function parseDateInput(str) { if (!str) return null; str = String(str).trim(); if (/^\d{2}-\d{2}-\d{4}$/.test(str)) { const [dd, mm, yyyy] = str.split('-'); return new Date(parseInt(yyyy, 10), parseInt(mm, 10) - 1, parseInt(dd, 10)); } if (/^\d{4}-\d{2}-\d{2}$/.test(str)) { const [yyyy, mm, dd] = str.split('-'); return new Date(parseInt(yyyy, 10), parseInt(mm, 10) - 1, parseInt(dd, 10)); } try { return new Date(str); } catch (e) { return null; } }
                function getMinDateForFp(el) {
                    ...
                    if (el.name === 'end') {
                        ...
                        return null; // allow navigation/select until start chosen
                    }
                    return null;
                }
