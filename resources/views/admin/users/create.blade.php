    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-2">
                <div
                    class="w-10 h-10 bg-gradient-to-br from-rose-500 to-pink-600 rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-gray-400 group-focus-within:text-rose-500 transition-colors"
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <select name="role"
                                ...
                                <option value="customer" {{ old('role') === 'customer' ? 'selected' : '' }}>Customer - Akses
                                    terbatas untuk pelanggan</option>
                                <option value="management-customer" {{ old('role') === 'management-customer' ? 'selected' : '' }}>Management Customer - Akses manajemen pelanggan</option>
                                <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>Admin - Akses penuh ke
                                    sistem</option>
                                <option value="management-epp" {{ old('role') === 'management-epp' ? 'selected' : '' }}>Management EPP - Akses persetujuan tingkat akhir</option>
                            </select>
                    ...
                    @php $showDept = in_array(old('role', ''), ['customer', 'management-customer']); @endphp
