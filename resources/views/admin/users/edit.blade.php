    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-2">
                <div
                    class="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="username" value="{{ old('username', $user->username) }}"
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-5">
                        <div class="flex items-start gap-3 mb-4">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-amber-900">Ubah Password</p>
                                <p class="text-xs text-amber-800 mt-1">Biarkan kosong jika tidak ingin mengubah password</p>
                            </div>
                        </div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password"
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 bg-white"
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <select name="role"
                                class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white appearance-none cursor-pointer">
                                <option value="customer" {{ old('role', $user->role) === 'customer' ? 'selected' : '' }}>
                                    Customer - Akses terbatas untuk pelanggan</option>
                    ...
                    @php $showDept = in_array(old('role', $user->role), ['customer', 'management-customer']); @endphp
                    <div class="group" id="department-group" style="{{ $showDept ? '' : 'display:none;' }}">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            Departement <span class="text-rose-500">*</span>
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-gray-400 group-focus-within:text-amber-500 transition-colors"
                            ...
                            <select name="department_id" id="department-select"
                                class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white appearance-none cursor-pointer"
                                @if($showDept) required @endif>
                                <option value="">-- Pilih Departement (jika ada) --</option>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            roleSelect && roleSelect.addEventListener('change', toggleDept);
                            toggleDept();
                        });
                    </script>
                </div>
                ...
                <div class="pt-8 border-t border-gray-200 mt-8">
                    <div class="flex flex-col sm:flex-row gap-3">
                        <button type="submit"
                            class="flex-1 sm:flex-initial px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white rounded-xl font-semibold shadow-lg shadow-amber-500/30 hover:shadow-xl hover:shadow-amber-500/40 transition-all duration-200 transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
