                                ...
                                <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        ...
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.236 4.53L8.53 10.7a.75.75 0 00-1.06 1.061l1.5 1.5a.75.75 0 001.137-.089l4-5.5z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </div>
                            ...
                            <div class="bg-gradient-to-r from-red-50 to-rose-50 rounded-lg p-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-semibold border {{ $colorClass }}">
                                    ...
                                    <tbody class="divide-y divide-amber-200">
                                        @foreach($notification->jobOrder->items as $item)
                                            <tr>
                                                ...
                                                <td class="py-2 px-3 text-center font-medium text-slate-800">{{ $item->jumlah ?? 0 }}
                                                </td>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-wrap gap-3">
                    @if($notification->jobOrder && $notification->type !== 'job_order_deleted')
                        <a href="{{ route('admin.joborder.show', $notification->jobOrder->id) }}"
