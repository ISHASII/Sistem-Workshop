    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-600 mt-1">Perbarui informasi satuan: <span class="font-semibold text-emerald-600">{{ $satuan->name }}</span></p>
            </div>
        </div>
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-amber-700 mt-1">Perubahan nama satuan akan mempengaruhi semua material yang menggunakan satuan ini. Pastikan perubahan sudah sesuai sebelum menyimpan.</p>
                        </div>
                    </div>
                </div>
